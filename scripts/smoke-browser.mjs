...
const gemSummary = await evaluate(`document.querySelector('.socketed-gems')?.textContent.includes('格雷爾之眼') && document.querySelector('.build-effects')?.textContent.includes('爆擊率')`)
