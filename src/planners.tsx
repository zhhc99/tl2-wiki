...
export function BuildsPage({lang,items}:{lang:Lang;items:PlannerEquipment[]}){
  ...
  const pickerItems=useMemo(()=>{
    ...
    return items.filter(item=>{
      ...
      return !needle||`${allText(item.name)} ${ngLabel(item.ngTier)||''}`.toLowerCase().includes(needle)
